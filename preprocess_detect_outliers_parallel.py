...
def fit_predict(method_name, OD_method):
...
for picklefile_name in picklefile_names:
    ...
    Parallel(n_jobs=4, prefer="threads")(delayed(fit_predict)(method_name, OD_method) for method_name, OD_method in methods.items())
